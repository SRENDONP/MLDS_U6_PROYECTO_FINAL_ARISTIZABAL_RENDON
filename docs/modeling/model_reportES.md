...
El segundo modelo desarrollado para resolver el problema de clasificación de Imágenes de rayos X se basa en la técnica de transfer learning utilizando la arquitectura preentrenada VGG16.
